...
//            }
//
//            if (i == lastDayOfMonth[monthCount]) {                  //computes average temp each month
...
//
//        }
//        for (int i = 0; i < lastDayOfMonth.length; i++) {               //determines what month hottest & coldest temperature
//            if (hottestDay <= lastDayOfMonth[i]) {                      //occurred in
//                hottest = months[i];
//
...
//        }
//
//        if (hottestDay > 30){                                           //method on day to convert day-of-year
//        boolean x = false;                                              // to day-of-month
//        int y = 0;
//            while(x != true){
